  ...
  return (
    ...
    <div className={`${fredoka.className} pt-16 text-slate-700 flex flex-col items-center justify-center`}>
      ...
      <div className="mt-6 text-xl w-1/2">
        ...
        <p className="mb-6">
          I'm a Full Stack Developer with a passion for creating excellent and innovative projects and collaboration. 
        </p>
        <p className="">
      ...
      {/* TECH STACK */}
      <div className="mt-6 text-xl w-1/2">
        <p className="italic text-2xl font-semibold mb-2">Technical Skills</p>
        <ul className="ml-6">
          <li>C#, Java, JavaScript, SQL</li>
          <li>ASP.NET, React, TypeScript, Node.js, Next.js, Flutter</li>
          <li>BootStrap, TailwindCSS, MaterialUI</li>
          <li>SQL, MySQL, NoSQL</li>
          <li>REST API</li>
          <li>SSAS, SSRS, SSIS</li>
          <li>VS Code, Visual Studio, CLI</li>
          <li>Windows, Linux</li>
        </ul>
        

        <div className="mt-4 ">
          <h3 className="italic font-semibold">Currently learning:</h3>
          <div className="ml-6">
            <ul>
              <li>Python</li>
              <li>AngularJS</li>
      ...
      <div className="mt-6 text-xl w-1/2">
        ...
        <div>          
          <p className="mt-3 ">
            ...
            <span className="block mt-5">
              As Agile Team Lead, I led a team of developers through an iterative software development process, ensuring smooth collaboration and alignment with project goals. I facilitated team meetings and internal discussions, resolving roadblocks and guiding decision-making in cases of disagreement. 


            </span>
            <span className="block mt-5">
              I managed client meetings, translating requirements into actionable development tasks. Alongside my leadership responsibilities, I was actively involved in both frontend and backend development, contributing significantly to the project's architecture and developing key microservices. Through fostering effective communication and keeping the team laser-focused, we successfully finished the project 25% ahead of schedule which allowed us to focus on polishing the project, exceeding expectations while maintaining a high quality product.
            </span>
            <span className="block mt-5">
        ...
        <div>
          <p className="mt-3">
            ...
            <span className="block">
              Client: Mobile App Development Course at School
            </span> 
            <span className="block mt-5">
              Tech Stack: Dart, Flutter       
            </span>
            <span className="block mt-5">
              Github/Repository Link: <a className="underline" href="https://github.com/JasonTat/2504-catproject">https://github.com/JasonTat/2504-catproject</a>
            </span>
          </p>
        </div>
      ...
      {/* socials */}
      <div className="mt-6 mb-8 text-xl w-1/2">
